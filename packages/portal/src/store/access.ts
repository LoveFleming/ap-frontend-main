...
import { baseRoutes, dynamicRoutes } from "#src/router/routes";
...
const initialState: AccessState = {
	wholeMenus: (() => {
		const menus = generateMenuItemsFromRoutes([...baseRoutes, ...dynamicRoutes]);
		console.log("DEBUG wholeMenus:", menus);
		return menus;
	})(),
	routeList: [...baseRoutes, ...dynamicRoutes],
	flatRouteList: flattenRoutes([...baseRoutes, ...dynamicRoutes]),

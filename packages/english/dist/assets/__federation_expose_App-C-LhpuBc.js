...
import IrregularVerbTable from './__federation_expose_IrregularVerbTable-DnOeeURd.js';
import ArticleTestArticles from './__federation_expose_ArticlePractice-BI9YkGAT.js';
...
function findDOMNode(node) {
  ...
  if (node instanceof React$K.Component) {
...
const {isValidElement,version: version$2} = await importShared('react');
...
function isReactElement(node) {
  return /*#__PURE__*/isValidElement(node) && !isFragment$1(node);
}
...
var StyleContext = /*#__PURE__*/React$I.createContext({
  hashPriority: 'low',
  cache: createCache(),
  defaultCache: true
});
...
var useInternalLayoutEffect = canUseDom() ? React$H.useLayoutEffect : React$H.useEffect;
var useLayoutEffect$1 = function useLayoutEffect2(callback, deps) {
  var firstMountRef = React$H.useRef(true);
...
var fullClone$2 = _objectSpread2({}, React$G);
...
var useInsertionEffectPolyfill = function useInsertionEffectPolyfill(renderEffect, effect, deps) {
  React$G.useMemo(renderEffect, deps);
...
var fullClone$1 = _objectSpread2({}, React$F);
...
function useGlobalCache(prefix, keyPath, cacheFn, onCacheRemove, onCacheEffect) {
  var _React$useContext = React$E.useContext(StyleContext), globalCache = _React$useContext.cache;
...
function useStyleRegister(info, styleFn) {
  ...
  var _React$useContext = React$D.useContext(StyleContext), autoClear = _React$useContext.autoClear; _React$useContext.mock; var defaultCache = _React$useContext.defaultCache, hashPriority = _React$useContext.hashPriority, container = _React$useContext.container, ssrInline = _React$useContext.ssrInline, transformers = _React$useContext.transformers, linters = _React$useContext.linters, cache = _React$useContext.cache, enableLayer = _React$useContext.layer;
  ...
  return function(node) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = /* @__PURE__ */ React$D.createElement(Empty, null);
    } else {
      var _ref6;
      styleNode = /* @__PURE__ */ React$D.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return /* @__PURE__ */ React$D.createElement(React$D.Fragment, null, styleNode, node);
  };
}
...
const DesignTokenContext = /*#__PURE__*/React$C.createContext(defaultConfig);
...
const ConfigContext = /*#__PURE__*/React$B.createContext({
...
function useComponentConfig(propName) {
  const context = React$B.useContext(ConfigContext);
  const {
    getPrefixCls,
    direction,
    getPopupContainer
...
const DisabledContext = /*#__PURE__*/React$A.createContext(false);

const React$z = await importShared('react');

const SizeContext = /*#__PURE__*/React$z.createContext(undefined);
...
function useEvent(callback) {
  var fnRef = React$y.useRef();
  fnRef.current = callback;
  var memoFn = React$y.useCallback(function () {
    var _fnRef$current;
...
function useSafeState(defaultValue) {
  var destroyRef = React$x.useRef(false);
  var _React$useState = React$x.useState(defaultValue),
...
function useUniqueMemo(memoFn, deps) {
  return React$w.useMemo(function () {
...
function genStyleUtils(config) {
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    ...
    var useCSSVar = function useCSSVar2(rootCls) {
      ...
      return [function(node) {
        return injectStyle && cssVar ? /* @__PURE__ */ React$v.createElement(React$v.Fragment, null, /* @__PURE__ */ React$v.createElement(CSSVarRegister, {
          rootCls,
          cssVar,
          component
        }), node) : node;
...
function formatToken(derivativeToken) {
  const {
    ...
    restToken = __rest$3(derivativeToken, ["override"]);
...
const getComputedToken = (originToken, overrideToken, theme) => {
  ...
  const {
    ...
    components = __rest$2(overrideToken, ["override"]);
  // Merge with override
  ...
  if (components) {
    Object.entries(components).forEach(([key, value]) => {
      const {
        ...
        componentTokens = __rest$2(value, ["theme"]);
...
function useToken() {
  const {
    ...
    override,
    cssVar
  } = React$u.useContext(DesignTokenContext);
...
var Context = /*#__PURE__*/React$t.createContext({});
...
const useNextFrame = (function () {
  var nextFrameRef = React$p.useRef(null);
...
const {useEffect: useEffect$3,useRef: useRef$6} = await importShared('react');
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React$n.useMemo(function () {
  ...
  var firstMountChangeRef = React$n.useRef(false);
  useEffect$3(function () {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = /*#__PURE__*/React$m.forwardRef(function (props, ref) {
    ...
    var _React$useContext = React$m.useContext(Context),
      contextMotion = _React$useContext.motion;
    var supportMotion = isSupportTransition(props, contextMotion);

    // Ref to the react node, it may be a HTMLElement
    var nodeRef = useRef$5();
    // Ref to the dom wrapper in case ref can not pass to HTMLElement
    var wrapperNodeRef = useRef$5();
    function getDomElement() {
      try {
    ...
    var renderedRef = React$m.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }

    // ====================== Refs ======================
    var setNodeRef = React$m.useCallback(function (node) {
    ...
    if ( /*#__PURE__*/React$m.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var originNodeRef = getNodeRef(motionChildren);
      if (!originNodeRef) {
        motionChildren = /*#__PURE__*/React$m.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return /*#__PURE__*/React$m.createElement(DomWrapper, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(CSSMotionList, [{
      ...
      value: function render() {
        ...
        var Component = component || React$l.Fragment;
        var motionProps = {};
        ...
        return /*#__PURE__*/React$l.createElement(Component, restProps, keyEntities.map(function (_ref2, index) {
          var status = _ref2.status,
            eventProps = _objectWithoutProperties(_ref2, _excluded2$1);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return /*#__PURE__*/React$l.createElement(CSSMotion$1, _extends({}, motionProps, {
            key: eventProps.key,
            visible: visible,
...
const React$k = await importShared('react');
const {useContext: useContext$2,useEffect: useEffect$2} = React$k;
...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return /*#__PURE__*/React$k.createElement(node.tag, _objectSpread2({
      key: key
    }, normalizeAttrs(node.attrs)), (node.children || []).map(function (child, index) {
      return generate(child, "".concat(key, "-").concat(node.tag, "-").concat(index));
    }));
  }
  return /*#__PURE__*/React$k.createElement(node.tag, _objectSpread2(_objectSpread2({
    key: key
...
var Icon = /*#__PURE__*/React$i.forwardRef(function (props, ref) {
  ...
  var _React$useContext = React$i.useContext(IconContext),
  ...
  var _normalizeTwoToneColo = normalizeTwoToneColors(twoToneColor),
    ...
    primaryColor = _normalizeTwoToneColo2[0],
    secondaryColor = _normalizeTwoToneColo2[1];
  return /*#__PURE__*/React$i.createElement("span", _extends({
    role: "img",
  ...
  }), /*#__PURE__*/React$i.createElement(IconBase, {
    icon: icon,
    primaryColor: primaryColor,
    secondaryColor: secondaryColor,
    style: svgStyle
...
function isFragment(child) {
  return child && /*#__PURE__*/React$h.isValidElement(child) && child.type === React$h.Fragment;
}
const replaceElement = (element, replacement, props) => {
  if (! /*#__PURE__*/React$h.isValidElement(element)) {
    return replacement;
  }
  return /*#__PURE__*/React$h.cloneElement(element, typeof props === 'function' ? props(element.props || {}) : props);
};
...
var LoadingOutlined = function LoadingOutlined2(props, ref) {
  return /* @__PURE__ */ React$g.createElement(Icon, _extends({}, props, {
    ref,
    icon: LoadingOutlined$1
  }));
};
var RefIcon = /* @__PURE__ */ React$g.forwardRef(LoadingOutlined);
...
const useSize = customSize => {
  const size = React$c.useContext(SizeContext);
  const mergedSize = React$c.useMemo(() => {
    if (!customSize) {
      return size;
    }
...
const React$b = await importShared('react');
const SpaceCompactItemContext = /*#__PURE__*/React$b.createContext(null);
const useCompactItemContext = (prefixCls, direction) => {
  const compactItemContext = React$b.useContext(SpaceCompactItemContext);
  const compactItemClassnames = React$b.useMemo(() => {
...
const React$a = await importShared('react');
const GroupSizeContext = /* @__PURE__ */ React$a.createContext(void 0);
const ButtonGroup = (props) => {
  ...
  return /* @__PURE__ */ React$a.createElement(GroupSizeContext.Provider, {
    value: size
  }, /* @__PURE__ */ React$a.createElement("div", Object.assign({}, others, {
    className: classes
  })));
};
...
function splitCNCharsBySpace(child, needInserted) {
  ...
  if (isString(child)) {
    return isTwoCNChar(child) ? /*#__PURE__*/React$9.createElement("span", null, child.split('').join(SPACE)) : /*#__PURE__*/React$9.createElement("span", null, child);
  }
  if (isFragment(child)) {
    return /*#__PURE__*/React$9.createElement("span", null, child);
  }
  return child;
}
function spaceChildren(children, needInserted) {
  ...
  return React$9.Children.map(childList, child => splitCNCharsBySpace(child, needInserted));
}
['default', 'primary', 'danger'].concat(_toConsumableArray(PresetColors));

const React$8 = await importShared('react');
const {forwardRef: forwardRef$3} = React$8;
const IconWrapper = /*#__PURE__*/forwardRef$3((props, ref) => {
  ...
  return /*#__PURE__*/React$8.createElement("span", {
    ref: ref,
...
const {forwardRef: forwardRef$2} = React$7;
const InnerLoadingIcon = /*#__PURE__*/forwardRef$2((props, ref) => {
  ...
  return /*#__PURE__*/React$7.createElement(IconWrapper, {
    prefixCls: prefixCls,
    className: mergedIconCls,
    style: style,
    ref: ref
  }, /*#__PURE__*/React$7.createElement(RefIcon, {
...
const DefaultLoadingIcon = props => {
  ...
  if (existIcon) {
    return /*#__PURE__*/React$7.createElement(InnerLoadingIcon, {
      prefixCls: prefixCls,
      className: className,
      style: style
    });
  }
  return /*#__PURE__*/React$7.createElement(CSSMotion, {
    visible: visible,
...
const {useEffect: useEffect$1,useRef: useRef$3,useState: useState$2} = await importShared('react');
...
const {forwardRef: forwardRef$1} = React$6;

const React$5 = await importShared('react');
const {useRef: useRef$2} = React$5;

const {useMemo: useMemo$4} = await importShared('react');

const React$4 = await importShared('react');
const {useMemo: useMemo$3} = React$4;

const React$3 = await importShared('react');
const {useRef: useRef$1} = React$3;

await importShared('react');

const React$2 = await importShared('react');
const {forwardRef,useMemo: useMemo$2} = React$2;
...
const {useMemo: useMemo$1} = React$1;
...
const {Children,useContext,useEffect,useMemo,useRef,useState: useState$1} = React;
...
const InternalCompoundedButton = /* @__PURE__ */ React.forwardRef((props, ref) => {
  ...
  const [innerLoading, setLoading] = useState$1(loadingOrDelay.loading);
  const [hasTwoCNChar, setHasTwoCNChar] = useState$1(false);
...
const App = () => {
  const [tab, setTab] = useState("vocab1200");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "English Learning" }),
    ...
    tab === "article" && /* @__PURE__ */ jsxRuntimeExports.jsx(ArticleTestArticles, {}),
    tab === "verb" && /* @__PURE__ */ jsxRuntimeExports.jsx(IrregularVerbTable, { setAppTab: setTab }),
